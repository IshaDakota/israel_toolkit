...
<div class="panel-display concept clearfix <?php if (!empty($classes)) { print $classes; } ?><?php if (!empty($class)) { print $class; } ?>" <?php if (!empty($css_id)) { print "id=\"$css_id\""; } ?>>
  <div class="row">
    ...
    <div class="col-md-4 sidebar panel-panel">
      <div class="row">
        <div class="panel-panel-inner jumbotron">
          <div>This educator tool is referenced in:</div>
