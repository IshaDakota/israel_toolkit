<div class="<?php print $classes; ?>"<?php print $attributes; ?>>
  <?php if (!$label_hidden): ?>
    <a class="collapsed" data-toggle="collapse" href="#collapse-background-resource"><div class="field-label"<?php print $title_attributes; ?>><span class="glyphicon glyphicon-plus-sign"></span>Background Resources</div></a>
  <?php endif; ?>
