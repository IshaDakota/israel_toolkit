<div class="<?php print $classes; ?>"<?php print $attributes; ?>>
  <?php if (!$label_hidden): ?>
    <a class="collapsed" data-toggle="collapse" href="#collapse-core-learnings"><div class="field-label"<?php print $title_attributes; ?>><span class="glyphicon glyphicon-plus-sign"></span><?php print $label ?></div></a>
  <?php endif; ?>
  <div id ="collapse-core-learnings" class="field-items collapse"<?php print $content_attributes; ?>>
